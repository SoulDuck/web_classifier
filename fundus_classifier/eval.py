...
def overlay(actmap , ori_img ,save_path , factor):
    ...
    cmap = plt.cm.jet
    plt.imsave(fname=os.path.join(save_path,'/home/ubuntu/web_classifier/media/tmp.png'), arr=cmap(actmap))
    cam_img=Image.open('/home/ubuntu/web_classifier/media/tmp.png')
